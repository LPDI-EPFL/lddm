...
from lddm.model.gvp import GVPModel, GVP, LayerNorm
# from lddm.model.gvp_transformer import GVPTransformerModel
from lddm.model.utils import cycle_counts, eigenfeatures
from lddm.constants import FLOAT_TYPE
...
class Dynamics(DynamicsBase):
    ...
    def _forward(self, x_atoms, h_atoms, mask_atoms, pocket, t, bonds_ligand=None,
                h_atoms_sc=None, e_atoms_sc=None, h_residues_sc=None, fragment_mask=None, fragment_edge_mask=None):
        """
        :param x_atoms:
        :param h_atoms:
        :param mask_atoms:
        ...
        :param fragment_mask: mask of fragments that are "known"
        :param fragment_edge_mask: mask of edges of fragments that are "known"
        :return:
        """
